@ModelType list(of RGPD_MVC.TypeIncident)
@Code
    ViewData("Title") = "Delete"
End Code

<div>
    <h4>Type d'incident : Suppression d'un élément.</h4>
    <hr />
    <table class="table">
        <tr>
        ...
        @code
            Dim i As Integer = 0
        End Code
        @For Each item As Typeincident In Model
            @<tr>
                @Using (Html.BeginForm("Delete", "TypeIncident", FormMethod.Post))
