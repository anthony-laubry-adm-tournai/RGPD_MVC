...
@Using (Html.BeginForm("Test", "AccesIllegitime", FormMethod.Post))
    ...
    <input type="submit" name="AccIll" value="- Accès illégitime à des données" class="linkButton mnuCreaRisque-current" />
