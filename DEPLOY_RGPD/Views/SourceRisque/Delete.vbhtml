@ModelType IEnumerable(Of RGPD_MVC.SourceRisque)
@Code
    ViewData("Title") = "Source des risques"
End Code

<div>
    <h4>Sources des risques : Suppression d'un élément.</h4>
    <hr />
    ...
    <table class="table">
        ...
        @code
            Dim i As Integer = 0
        End Code
        @For Each item As SourceRisque In Model
            @<tr>
                @Using (Html.BeginForm("Delete", "SourceRisque", FormMethod.Post))
