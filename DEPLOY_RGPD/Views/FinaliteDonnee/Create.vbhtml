@ModelType RGPD_MVC.FinaliteDonnee
@Code
...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        <h4>Finalité des données : Ajout d'un nouvel élément.</h4>
        <hr />
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                @If ViewBag.IsPresent IsNot Nothing Then
                    @Html.ValidationMessageFor(Function(model) model.Libelle, ViewBag.IsPresent.ToString(), New With {.class = "text-danger"})@Html.ValidationMessageFor(Function(model) model.Libelle, "", New With {.class = "text-danger"})
                Else
...
<script>
    @code
        If Session("Ajout") IsNot Nothing AndAlso CBool(Session("Ajout")) Then
            Session("Ajout") = False
    End Code
    alert("Nouvelle finalité de donnée correctement ajoutée.");
    @code
    End If
    End Code
</script>