...
@Using (Html.BeginForm())
    ...
    @<h4>Support des données : Modification d'un élément.</h4>
    ...
    @For Each item As SupportDonnee In Model
            @<tr>
                <td style="display:none;">@Html.Hidden("Id",item.Id)</td>
                 ...
                 <td>@Html.EditorFor(Function(modelItem) modelItem(i).Libelle, New With {.htmlAttributes = New With {.class = "form-control", .style = "width:100%;min-width:300px;", _
                                                                                                                     .autocomplete = "off"}})</td>
