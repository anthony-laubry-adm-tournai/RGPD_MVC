@ModelType RGPD_MVC.DureeConservationDonnee
@Code
...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        <h4>Durée de conservation des données : Ajout d'un nouvel élément.</h4>
        <hr />
...
<script>
    @code
        If Session("Ajout") IsNot Nothing AndAlso CBool(Session("Ajout")) Then
            Session("Ajout") = False
    End Code
    alert("Nouvelle durée de conservation correctement ajoutée.");
    @code
    End If
    End Code
</script>