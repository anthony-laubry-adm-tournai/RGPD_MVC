@ModelType ienumerable(of RGPD_MVC.PersonneConcernee)
@Code
    ViewData("Title") = "Personne concernée"
End Code

<div>
    <h4>Personne concernée : Suppression d'un élément.</h4>
    <hr />
    ...
    <table class="table">
        ...
        @code
            Dim i As Integer = 0
        End Code
        @For Each item As PersonneConcernee In Model
            @<tr>
                @Using (Html.BeginForm("Delete", "PersonneConcernee", FormMethod.Post))
