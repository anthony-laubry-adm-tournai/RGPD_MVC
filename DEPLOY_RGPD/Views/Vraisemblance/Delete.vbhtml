@ModelType IEnumerable(Of RGPD_MVC.Vraisemblance)
@Code
    ViewData("Title") = "Vraisemblance de risque"
End Code

<div>
    <h4>Vraisemblance de réalisation d'un risque : Suppression d'un élément.</h4>
    <hr />
    ...
    <table class="table">
        ...
        @code
            Dim i As Integer = 0
        End Code
        @For Each item As Vraisemblance In Model
            @<tr>
                @Using (Html.BeginForm("Delete", "Vraisemblance", FormMethod.Post))
