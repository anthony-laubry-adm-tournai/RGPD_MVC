@ModelType RGPD_MVC.Vraisemblance
@Code
...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        <h4>Vraisemblance de réalisation d'un risque : Ajout d'un nouvel élément.</h4>
        <hr />
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                @If ViewBag.IsPresent IsNot Nothing Then
                    ...
                    ViewBag.IsPresent = String.Empty
                Else
...
<script>
    @code
        If Session("Ajout") IsNot Nothing AndAlso CBool(Session("Ajout")) Then
            Session("Ajout") = False
    End Code
    alert("Nouveau type de vraisemblance correctement ajoutée.");
    @code
    End If
    End Code
</script>