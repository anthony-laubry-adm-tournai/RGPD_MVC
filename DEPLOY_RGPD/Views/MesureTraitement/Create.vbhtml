...
@Using (Html.BeginForm("Create", "MesureTraitement", FormMethod.Post, New With {.enctype = "multipart/form-data"}))
...
@*Modification à la demande d'anaïs => cacher les mesures prédéfinies*@
    ...
    @If listeMesure IsNot Nothing Then
...
<script>
    ...
    function GetDynamicTextbox(value) {
        ...
        var descr = document.getElementById("descr_" + value).innerText;//var descr = $('#descr_' + value).text;
