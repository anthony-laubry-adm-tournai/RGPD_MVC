@ModelType IEnumerable(Of RGPD_MVC.Gravite)
@Code
    ViewData("Title") = "Gravité"
End Code

<div>
    <h4>Gravité de réalisation d'un risque : Suppression d'un élément.</h4>
    <hr />
    ...
    <table class="table">
        ...
        @code
            Dim i As Integer = 0
        End Code
        @For Each item As Gravite In Model
            @<tr>
                @Using (Html.BeginForm("Delete", "Gravite", FormMethod.Post))
