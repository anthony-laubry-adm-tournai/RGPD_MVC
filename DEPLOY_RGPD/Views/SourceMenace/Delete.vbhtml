@ModelType IEnumerable(Of RGPD_MVC.SourceMenace)
@Code
    ViewData("Title") = "Source des menaces"
End Code

<div>
    <h4>Sources des menaces : Suppression d'un élément.</h4>
    <hr />
    ...
    <table class="table">
        ...
        @code
            Dim i As Integer = 0
        End Code
        @For Each item As SourceMenace In Model
            @<tr>
                @Using (Html.BeginForm("Delete", "SourceMenace", FormMethod.Post))
