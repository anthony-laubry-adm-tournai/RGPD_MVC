@ModelType RGPD_MVC.DonneeCaractereSensible
@Code
...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        <h4>Données à caractère sensible : Ajout d'un nouvel élément.</h4>
        <hr />
...
<script>
    @code
        If Session("Ajout") IsNot Nothing AndAlso CBool(Session("Ajout")) Then
            Session("Ajout") = False
    End Code
    alert("Nouvelle donnée à caractère sensible correctement ajoutée.");
    @code
    End If
    End Code
</script>